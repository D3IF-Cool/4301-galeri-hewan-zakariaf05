package org.d3if4074.galerihewan
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showBack() {
        ...
        imageView.setImageResource(resourceIdBack)

        val textViewBack: TextView = findViewById(R.id.nameTextView)
        textViewBack.text = hewan[index]
    }
}